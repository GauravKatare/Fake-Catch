...
def fun(filename):
    ...
    file_job = client.submit_job_local_file(filename, metadata="This_is_some_job_metadata", callback_url="", skip_diarization=False)
    job_id = file_job.id
...
mylist=fun("/home/gaurav/Documents/raj.wav")
